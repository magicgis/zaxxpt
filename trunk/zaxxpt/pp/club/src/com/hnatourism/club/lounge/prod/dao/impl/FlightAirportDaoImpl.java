...
public class FlightAirportDaoImpl extends AbstractIBatisDaoSupport 
		implements IFlightAirportDao {
	// log 
	private static final Log log = LogFactory.getLog(FlightAirportDaoImpl.class);
	...
	public Object findByCode(String code) throws DataAccessException {
		...
		return getPersistanceManager().find("findFlightAirportByCode", code);
	}
}