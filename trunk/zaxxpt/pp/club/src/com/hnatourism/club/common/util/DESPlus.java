...
public class DESPlus
{
	...
	private static String strDefaultKey = "cebbank"; // 默认密钥
	...
	public static void main(String[] args)
	{
		...
		String test = "<bankDataModel><corpCode>100011743</corpCode><userCode>1000001</userCode><corpFlag>2000000002</corpFlag><transferTime>"+new Date().getTime()+"</transferTime></bankDataModel>";
		//String test="123456789@"+System.currentTimeMillis();
		DESPlus des;
		try
		{
			des = new DESPlus( "cebbank" );//定义密钥
