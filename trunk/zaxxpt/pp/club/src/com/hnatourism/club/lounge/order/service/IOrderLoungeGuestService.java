package com.hnatourism.club.lounge.order.service;
 ...
 * 
 */
public interface IOrderLoungeGuestService  extends IService{
	/**
	 * 【新增】（系统生成方法）
	 * @param domain
	 * @return
	 ...
	 * @throws BusinessException
	 */
	boolean checkUniqueness(AbstractVo vo) throws BusinessException;
