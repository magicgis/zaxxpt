...
<div class="jd_fy_box margin5">
    <ul>
        ...
        <li class="jd_fy"> ${domain_cn }会员申请： </li>
...
<div class="Wmargin">
    <table cellspacing="1" cellpadding="0" border="0" class="BuyCard">
        ...
        <s:iterator value="sysOrgList" var="sysOrg">
            <tr>
                <td><s:property value="#sysOrg.cityVo.pcName"/></td>
                <td><s:property value="#sysOrg.address"/></td>
                <td><s:property value="#sysOrg.phone"/></td>
            </tr>
        </s:iterator>
        <!-- 
            <tr>
