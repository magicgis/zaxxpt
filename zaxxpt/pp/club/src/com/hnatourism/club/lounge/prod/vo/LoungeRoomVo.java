...
public class LoungeRoomVo extends AbstractVo{
	/**
	 * ${c.getComments()}
	 */
	private String id;
	...
	//价格列表
	private List<LoungePriceVo> pricelist;
	//休息室维修时间
	private List<LoungeLimitVo> limitList;
	//工作时间列表
	...
	public List<LoungePriceVo> getPricelist() {
		return pricelist;
	}

	public void setPricelist(List<LoungePriceVo> pricelist) {
	...
	public LoungeInfoVo getLounge() {
		return lounge;
	}

	public void setLounge(LoungeInfoVo lounge) {
		this.lounge = lounge;
	}

	public List<LoungeLimitVo> getLimitList() {
		return limitList;
	}

	public void setLimitList(List<LoungeLimitVo> limitList) {
