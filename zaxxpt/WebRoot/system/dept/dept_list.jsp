  ...
  <body>
  	<!-- 查询条件 -->
  		<div style="margin-left: 30px;margin-top: 30px;">
  			...
  			&nbsp;&nbsp;<a href="<%=basePath%>/system/dept/dept_info.jsp">添   加</a>
  		</div>
  <!-- 查询结果 -->
    	...
    	<div>
    		<table  border="1" width="70%">
    			<tr>
    				<th>序号</th><th>组织机构编号</th><th>组织机构名称</th><th>备注</th><th>上级组织</th>
    				<th>编辑</th><th>删除</th>
    			</tr>
				<tbody>
    			<c:forEach items="${master}" var="dept" varStatus="status">
    				<tr>
    					...
    					<td><a href="<%=basePath %>sys/dept_view.action?selectId=${dept.id}">修改</a></td>
    					<td><a href="<%=basePath %>sys/dept_delete.action?selectId=${dept.id}">删除</a></td>
    				</tr>
    			</c:forEach>
    			</tbody>
    		</table>
